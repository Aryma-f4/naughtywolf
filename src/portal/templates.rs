...
pub fn callback_detail_page(
    ...
    let tasking_panel = format!(
        r##"<section class="callback-tasking panel" data-callback-tasking data-live-output data-tab-panel="tasking"
          ...
          <div class="task-filters" data-tab-panel="tasking">
            ...
            <label>State<span class="select-icon-field"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 4h18l-7 8v6l-4 2v-8Z"/></svg><select data-task-state-filter><option value="">All states</option><option value="pending">Queued</option><option value="delivering">Delivering</option><option value="delivered">Delivered</option><option value="processing">Processing</option><option value="completed">Completed</option><option value="error">Error</option><option value="cancelled">Cancelled</option></select></span></label>
            <label>Errors<span class="select-icon-field"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M12 8v4M12 16h.01"/></svg><select data-task-error-filter><option value="">All output</option><option value="errors">Errors only</option></select></span></label>
          </div>
    ...
    let module_studio = format!(
        ...
        <form class="custom-code-form" data-custom-code-form hidden>
          <div class="form-field"><label for="module-language">Interpreter</label><span class="select-icon-field"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="4" width="18" height="16" rx="2"/><path d="m6 9 3 3-3 3M11 15h7"/></svg><select id="module-language" name="language"><option value="shell">Shell</option><option value="python">Python 3</option><option value="powershell">PowerShell</option></select></span></div>
          <div class="form-field"><label for="module-timeout">Timeout</label><span class="select-icon-field"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/></svg><select id="module-timeout" name="timeout"><option value="30000">30 seconds</option><option value="60000" selected>60 seconds</option><option value="120000">2 minutes</option></select></span></div>
